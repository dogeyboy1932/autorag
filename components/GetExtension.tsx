...
export default function GetExtension() {
  ...
  return (
    <Panel
      title="Keep things from the pages you read"
      right={
        <a
    ...
    >
      <p style={{ margin: '0 0 10px', fontSize: 13, color: 'var(--muted)' }}>
        Everything on this page works on text you paste in. The extension adds the part a
        web page cannot do: highlight anything on any site and keep it in one click, read
        PDFs so their text can be selected at all, and ask questions from the side panel
